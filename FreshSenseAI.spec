...
a = Analysis(
    ...
    datas=[
        ...
        ("evaluation/manifests/expanded_12_class_v1.json", "evaluation/manifests"),
        ("evaluation/reports/expanded_12_class/gated_test/evaluation_report.json", "evaluation/reports/expanded_12_class/gated_test"),
        ("evaluation/reports/expanded_12_class/open_set_calibration.json", "evaluation/reports/expanded_12_class"),
