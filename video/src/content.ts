...
export const SCENES: readonly Scene[] = [
  ...
  {id: 'overview', kind: 'screenshot', startFrame: 150, endFrame: 360, screenshot: 'overview.png', headline: 'One shared inspection workspace', narration: 'FreshSense gives grocery teams a shared inspection record.', callouts: [{label: 'Live inspection history', x: 73, y: 45, delayFrame: 40}]},
  {id: 'batch', kind: 'screenshot', startFrame: 360, endFrame: 690, screenshot: 'batch-inspection.png', headline: 'Inspect a batch in one step', narration: 'Staff can add a photo or batch of twenty. The model covers apples, bananas, oranges, mangoes, tomatoes, and pears. Photos are not stored by default.', callouts: [{label: 'Camera or multi-photo upload', x: 36, y: 68, delayFrame: 45}, {label: 'Up to 20 images', x: 47, y: 58, delayFrame: 100}]},
  ...
  {id: 'agent', kind: 'screenshot', startFrame: 990, endFrame: 1290, screenshot: 'agent-activity.png', headline: 'A bounded Agent follows through', narration: 'A bounded Agent checks history and reviewed guidance, creates follow-up tasks, and notifies staff. High-risk actions require manager approval.', callouts: [{label: 'Automatic follow-up tasks', x: 44, y: 31, delayFrame: 45}, {label: 'Manager approval boundary', x: 70, y: 31, delayFrame: 115}]},
  {id: 'review', kind: 'screenshot', startFrame: 1290, endFrame: 1500, screenshot: 'review-queue.png', headline: 'People make the final call', narration: 'Staff confirm or correct results.', callouts: [{label: 'Human-observed outcome', x: 72, y: 42, delayFrame: 45}]},
  {id: 'manager', kind: 'manager', startFrame: 1500, endFrame: 1680, screenshot: 'manager-chat.png', headline: 'Grounded answers, daily evidence', narration: 'Managers ask grounded questions and check the daily report.', callouts: [{label: 'Workspace citations', x: 61, y: 56, delayFrame: 30}]},
